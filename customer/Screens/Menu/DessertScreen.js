...
function DessertScreen() {
  const menuItems = [
    {id: 1,name: 'Chocolate Bingsu',price: 189,icon: '🍫',},
    {id: 2,name: 'Honey Toast',price: 79,icon: '🍞',},
    {id: 3,name: 'Macarons',price: 45,icon: '🍪',},
    {id: 4,name: 'Blueberry Cheesecake',price: 65,icon: '🍰',},
    {id: 5,name: 'Banoffee Pie',price: 65,icon: '🍌',},
    {id: 6,name: 'Strawberry Bingsu',price: 189,icon: '🍓',},
    {id: 7,name: 'Orange Cake',price: 65,icon: '🍊',},
    {id: 8,name: 'Brownie',price: 45,icon: '🍫',},
    {id: 9,name: 'Oreo Bingsu',price: 189,icon: '🍨',},
    {id: 10,name: 'Volcano Bingsu',price: 159,icon: '🍰',},
  ];
      ...
      showsVerticalScrollIndicator={false}>
        ...
        {menuItems.map((item) => (
          <TouchableOpacity key={item.id} style={styles.menuCard} 
            activeOpacity={0.8} >
            <View style={styles.imageBox}><Text style={styles.icon}>{item.icon}</Text></View>

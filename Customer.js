...
import {StyleSheet,StatusBar,View,Text,TouchableOpacity,ScrollView, Alert,Platform,} from 'react-native';

const colors = { bg: '#FBF9F5',card: '#FFFFFF', border: '#E6DFD5',text: '#3D3731',dim: '#8C827A',cyan: '#A0826C',};
  ...
  return (
    <View style={styles.screenContainer}>
      ...
      <View style={styles.centerContent}>
        ...
        <Text style={styles.subtitle}>Click to sart</Text>
...
function HomeScreen() {
  ...
  const categories = [
    { id: 1, title: 'อาหารเรียกน้ำย่อย', subtitle: 'Appetizers', icon: '🥗' },
    { id: 2, title: 'อาหารจานหลัก', subtitle: 'Main Course', icon: '🍛' },
    { id: 3, title: 'ของหวาน', subtitle: 'Desserts', icon: '🍰' },
    { id: 4, title: 'น้ำดื่ม', subtitle: 'Drinks', icon: '🥤' },
  ];
...
const styles = StyleSheet.create({
  ...
  staffButton: {position: 'absolute',top: 16,right: 24,width: 48,height: 48,borderRadius: 24,backgroundColor: colors.card,
  ...
  welcomeText: { fontSize: 42, fontWeight: '700', color: colors.text, marginBottom: 8 },
